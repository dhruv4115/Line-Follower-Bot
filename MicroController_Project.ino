...
//  Read ultrasonic sensor values
  ...
  //  Move forward
    ...
    analogWrite(rightMotorBwd,0);
}else if((I1==0 && I2==0 && I3==1 && (I4==1 || I5==1)) || (I1==0 && I2==0 && I3==0 && (I4==1 || I5==1))){
  //    Turn right
    analogWrite(leftMotorFwd,0);
    analogWrite(leftMotorBwd,50);
    analogWrite(rightMotorFwd,30); 
    analogWrite(rightMotorBwd,0);
}else if(((I1==1 || I2==1) && I3==1 && I4==0 && I5==0) || ((I1==1 || I2==1) && I3==0 && I4==0 && I5==0)){
  //    Turn left
    analogWrite(leftMotorFwd,30);
    analogWrite(leftMotorBwd,0);
    analogWrite(rightMotorFwd,0); 
    analogWrite(rightMotorBwd,40);
}else if(I1==1 && I2==1 && I3==1 && I4==1 && I5==1){
//  turn left
  analogWrite(leftMotorFwd,30);
  analogWrite(leftMotorBwd,0);
  analogWrite(rightMotorFwd,0);
